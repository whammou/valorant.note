...
* List of Oneoff Tasks :typTask:catOneoff:VALORANT:meta:
** TODO Valorant Workflow :opStructure:opLayout:
...
*** PEND Choose Format for Workflow
- *OBJECTIVE:* Choose a format for storing =strategies= information in
** TODO Learn Retake Smokes :opStrategy:
